<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <span style='cursor:pointer' class="nav-link dropdown-toggle list-group-item list-group-item-action bg-white coloring" id="navbarDropdown" data-toggle="dropdown"><i style='color:#0095FF' class='fa fa-user'></i> Patient</span>
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="Add-Patient.php">Add Patient</a>
            <a class="dropdown-item" href="Manage-Patient.php">Manage Patient</a>
        </div>
        <a href="Search.php" class="list-group-item list-group-item-action bg-white coloring"><i style='color:#0095FF' class='fa fa-search'></i> Search</a>
        </div>
    </div>
    <!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                ...
                <img src="<?php echo $img; ?>doctor.png" alt="" width="40px" height="40px">
                <?php echo "Dr." . $_SESSION['Doctor']; ?>
                </a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
